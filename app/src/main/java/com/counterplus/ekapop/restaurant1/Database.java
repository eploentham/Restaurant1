...
public class Database {
    ...
    public String tbNameTableChange="t_tablechange", tbNameFoodsSpecific="b_foods_specific", tbNameFoodsCat="b_foods_category", tbNameFoodsPrint="b_foods_print";
    public String tbNameBrand="b_brand", tbNameModel="b_model";

...
mysql_query("SET NAMES UTF8");
    ...
    $obj = mysql_query("update b_foods Set active = '3', status_void = '1', void_user = '".$_POST['void_user']."', void_date = now() Where foods_id = '".$_POST['foods_id']."' ");
    $ok="";
    $err="";
    if(!$objQuery){
        $ok="0";
    ...
    $tmp["sql"] = "update b_foods Set active = '3', status_void = '1', void_user = '".$_POST['void_user']."', void_date = now() Where foods_id = '".$_POST['foods_id']."' ";
    $tmp["error"] = $err;

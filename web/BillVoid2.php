...
$objQuery = mysql_query("Select password1, user_id From b_user Where password1 = '".$_POST['password']."' ");
...
if($intNumRows==0){
    ...
    $obj = mysql_query("update t_bill Set active = '1', status_void = '1', void_user = '".$_POST['void_user']."' Where bill_id = '".$_POST['bill_id']."' ");
